...
const WORKER_ACTIONS: Record<string, { next: string; label: string }[]> = {
  pending: [
    { next: "accepted", label: "Accept Job" },
    { next: "rejected", label: "Decline" },
  ],
...
export default function WorkerHireDetailScreen() {
        ...
        <View style={styles.footer}>
          {actions.map((action) => (
            <Button
              ...
              loading={updating}
              variant={action.next === "rejected" ? "outline" : "primary"}
